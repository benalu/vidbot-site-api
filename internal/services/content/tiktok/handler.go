...
func (h *Handler) Extract(c *gin.Context) {
	...
	// cek cache dulu
	if cached, err := downloader.CacheGet[mediaresponse.TikTokResponse]("content", "tiktok", req.URL); err == nil && cached != nil {
